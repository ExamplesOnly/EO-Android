package com.solvevolve.gallerypicker.utils.scroll
...
class FastScroller(context: Context, private val mRecyclerView: FastScrollRecyclerView?, attrs: AttributeSet) {
    ...
    init {
        ...
        try {
            ...
            val popupPosition = typedArray.getInteger(R.styleable.FastScrollRecyclerView_fastScrollPopupPosition, com.solvevolve.gallerypicker.utils.scroll.FastScroller.FastScrollerPopupPosition.ADJACENT)
