...
import com.solvevolve.gallerypicker.presenter.PhotosPresenterImpl
        ...
        try {
            if (imagescursor != null && imagescursor.count > 0) {
                if (imagescursor.moveToFirst()) {
                    ...
                    do {
                        val id:String = imagescursor.getString(idColumn)
                        val data:String = imagescursor.getString(dataColumn)
