package com.examplesonly.gallerypicker.utils.scroll
...
import com.picker.gallery.utils.scroll.FastScrollPopup
import com.picker.gallery.utils.scroll.OnFastScrollStateChangeListener
...
class FastScroller(context: Context, private val mRecyclerView: FastScrollRecyclerView?, attrs: AttributeSet) {
    ...
    init {
        ...
        try {
            ...
            val popupPosition = typedArray.getInteger(R.styleable.FastScrollRecyclerView_fastScrollPopupPosition, com.examplesonly.gallerypicker.utils.scroll.FastScroller.FastScrollerPopupPosition.ADJACENT)
